...
<html lang="en">
<head>
    <title>Order List - MMU FOOD</title>
...
<?php include '../vendor/v_navbar.php'; ?>
    <div class="container">
        <main>
            <h1 style="margin-bottom: 25px;">Welcome back, <?php echo htmlspecialchars($username)?></h1> 
            <div style="display:flex; justify-content: space-between;">
                <h3>Pending Orders</h3>
                <button onclick="window.location.href='vendor_grandlist.php'">Past Order List</button>
            </div>
            <?php
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    echo '<tr>
                            ...
                            <td><button class="view-button" onclick="window.location.href=\'vendor_orderdetails.php?id=' . $row["Order_ID"] . '\'">View</button></td>
                        </tr>';
                }
                echo '</tbody>
                    </table>';
                ...
                echo '<div class="no-orders">
                        <p>You have no pending orders for now</p>
                    </div>';
            }
